// Havoc MCP server -- provides pentest tools to Claude agents
// Replaces Shannon's Playwright-focused MCP with shell execution + attack logging

import { execSync, spawnSync } from 'node:child_process';
import { readFileSync, writeFileSync, appendFileSync, existsSync } from 'node:fs';
import { join } from 'node:path';
import type { AttackEvent } from '../../src/types/index.js';

// Tool definitions returned to Claude Agent SDK
...
const LOG_DIR = process.env.HAVOC_LOG_DIR ?? './attack-logs';
